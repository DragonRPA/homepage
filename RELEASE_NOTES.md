...
## [v0.4.6.Build.2] - 2026-09-13 09:37

### ⚡ 구글 슬라이드 전송 전용 벡터 아이콘 탑재 및 F11 원터치 단축키 반영
- **구글 슬라이드 전송 전용 벡터 아이콘 동기화**:
  - 아이콘 보기 전환 시 텍스트 대신 앰버/골드 테마(`#D97706`) 슬라이드 캔버스 프레임과 `G`가 각인된 전용 벡터 아이콘 표출
- **F11 단축키 정의 및 웹 설명서 단축키 맵 최신화**:
  - 파워포인트(F10)와 구글 슬라이드(F11) 단축키 체계 1:1 분리 및 웹 포털 안내 연동
- **v1.4.0.15 최신 바이너리 웹 배포 동기화 (`ManualStudio_Setup_v1.4.0.exe`)**
